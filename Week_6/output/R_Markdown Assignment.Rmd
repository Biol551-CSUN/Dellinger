...
title: "Visualizing Open-Source Ocean Plots Using Markdown"
...
## *VISUALIZING OPEN SOURCE OCEAN DATA*
This can be done using the [marmap](https://cran.r-project.org/web/packages/marmap/index.html) package, which is one of many R packages that provides open-source data for visualizing physical, chemical and biological characteristics of oceanic processes. (bathymetry).
...
## *VISUALIZING MARINE BIOLOGY GIT HUB DATA*
